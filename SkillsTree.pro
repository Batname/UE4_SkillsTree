...
SkillsTreeRootPath=/media/bat/SecondSSD/Projects/Unreal/SkillsTree

gameProjectFile=/media/bat/SecondSSD/Projects/Unreal/SkillsTree/SkillsTree.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(SkillsTreeSource.pri)
include(SkillsTreeHeader.pri)
include(SkillsTreeConfig.pri)
include(SkillsTreeIncludes.pri)
include(SkillsTreeDefines.pri)
...
SkillsTree-Linux-Debug.commands = $$build SkillsTree Linux Debug  -project="\"$$gameProjectFile\"" $$args
SkillsTree-Linux-DebugGame.commands = $$build SkillsTree Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
SkillsTree-Linux-Shipping.commands = $$build SkillsTree Linux Shipping  -project="\"$$gameProjectFile\"" $$args
SkillsTree-Linux-Test.commands = $$build SkillsTree Linux Test  -project="\"$$gameProjectFile\"" $$args
SkillsTree.commands = $$build SkillsTree Linux Development  -project="\"$$gameProjectFile\"" $$args

SkillsTreeEditor-Linux-Debug.commands = $$build SkillsTreeEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
SkillsTreeEditor-Linux-DebugGame.commands = $$build SkillsTreeEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
SkillsTreeEditor-Linux-Shipping.commands = $$build SkillsTreeEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
SkillsTreeEditor-Linux-Test.commands = $$build SkillsTreeEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
SkillsTreeEditor.commands = $$build SkillsTreeEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	SkillsTree-Linux-Debug \
	SkillsTree-Linux-DebugGame \
	SkillsTree-Linux-Shipping \
	SkillsTree-Linux-Test \
	SkillsTree \
	SkillsTreeEditor-Linux-Debug \
	SkillsTreeEditor-Linux-DebugGame \
	SkillsTreeEditor-Linux-Shipping \
	SkillsTreeEditor-Linux-Test \
	SkillsTreeEditor \
