...
SkillsTree-Linux-Debug:
	 $(PROJECTBUILD) SkillsTree Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SkillsTree-Linux-DebugGame:
	 $(PROJECTBUILD) SkillsTree Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SkillsTree-Linux-Shipping:
	 $(PROJECTBUILD) SkillsTree Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SkillsTree-Linux-Test:
	 $(PROJECTBUILD) SkillsTree Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SkillsTree:
	 $(PROJECTBUILD) SkillsTree Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

SkillsTreeEditor-Linux-Debug:
	 $(PROJECTBUILD) SkillsTreeEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SkillsTreeEditor-Linux-DebugGame:
	 $(PROJECTBUILD) SkillsTreeEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SkillsTreeEditor-Linux-Shipping:
	 $(PROJECTBUILD) SkillsTreeEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SkillsTreeEditor-Linux-Test:
	 $(PROJECTBUILD) SkillsTreeEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SkillsTreeEditor:
	 $(PROJECTBUILD) SkillsTreeEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
